...
/**
 * Zone overlay shown while a window is being dragged.
 *
                    ...
                    Item {
                        ...
                        Repeater {
                            ...
                            ZoneIndicator {
                                ...
                                hovered: monitorScope.screenName === TilingAssistant.monitorName && TilingAssistant.hoveredZone === indicator.index
                            }
                        }
                    }
                }
