...
Item {
    ...
    ContentPage {
        ...
        ContentSection {
            ...
            HyprOptionNote {
                notes: [
                    { "icon": "bolt", "text": Translation.tr("Picking one tells the compositor straight away, updates GTK's own copy of the setting, and writes the four variables that make it stick. Windows already open keep the old pointer until they are restarted.") },
