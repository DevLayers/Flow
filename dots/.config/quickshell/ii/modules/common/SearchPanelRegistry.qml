...
Singleton {
    ...
    readonly property var panels: [
        ...
        { id: "calendar", source: "CalendarPanel.qml", prefixKey: "", keywords: ["calendar", "agenda", "event", "evento", "schedule", "meeting"], label: qsTr("Calendar"), icon: "calendar_month", width: () => 720, enabled: () => Config.options.search.modules.calendar.enable, accent: true, focusMode: "list", queryProperty: "searchQuery" },
        { id: "tasks", source: "TasksPanel.qml", prefixKey: "", keywords: ["tasks", "task", "tarefas", "todo"], label: qsTr("Tasks"), icon: "task_alt", width: () => 720, enabled: () => Config.options.search.modules.tasks.enable, accent: true, focusMode: "list", queryProperty: "searchQuery" },
        { id: "timers", source: "TimersPanel.qml", prefixKey: "", keywords: ["timer", "timers", "pomodoro", "alarm"], label: qsTr("Timers"), icon: "timer", width: () => 720, enabled: () => Config.options.search.modules.timers.enable, accent: true, focusMode: "list", queryProperty: "searchQuery" },
        { id: "settings", source: "SettingsTogglesPanel.qml", prefixKey: "", keywords: ["settings", "config", "configurar", "dotfiles"], label: qsTr("Settings"), icon: "settings", width: () => 720, enabled: () => Config.options.search.modules.settingsToggles.enable, accent: true, focusMode: "list", queryProperty: "searchQuery" },
        { id: "keybinds", source: "KeybindsPanel.qml", prefixKey: "", keywords: ["keybind", "keybinds", "atalho", "shortcut", "bind"], label: qsTr("Keybinds"), icon: "keyboard", width: () => 720, enabled: () => Config.options.search.modules.keybinds.enable, accent: true, focusMode: "list", queryProperty: "searchQuery" }
    ]
