...
/** A local alarm is shown before it is persisted. */
Rectangle {
    id: root

    property var messageData: null
    property var card: null
    readonly property var reminder: root.card?.data?.reminder ?? ({})
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                StyledText {
                    Layout.fillWidth: true
                    text: Translation.tr("Create this reminder?")
                    wrapMode: Text.Wrap
        ...
        RowLayout {
            ...
            RippleButton {
                ...
                onClicked: Ai.rejectReminder(root.messageData)
            ...
            RippleButton {
                ...
                onClicked: Ai.approveReminder(root.messageData)

                contentItem: StyledText {
                    text: Translation.tr("Create reminder")
                    font.pixelSize: Appearance.font.pixelSize.smaller
