...
VIDEO_OPTS="no-audio loop hwdec=nvdec scale=bilinear interpolation=no video-sync=display-resample panscan=1.08 input-ipc-server=/tmp/mpvpaper-\$monitor.sock load-scripts=no"
